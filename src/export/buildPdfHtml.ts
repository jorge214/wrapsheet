...
export function buildPdfHtml(
  ...
  // iPad (expo-print, desktop-class): margens efetivas mais finas -> a tabela
  // encosta ao papel. Laterais maiores SÓ no iPad (a folha só encolhe um
  // bocadinho, não muda a largura do conteúdo). iPhone/PC ficam nos 6mm.
  const pageMargin =
    extra?.orientation === "portrait"
      ? (extra?.ipadPdf ? "7mm 14mm 3mm 14mm" : "7mm 6mm 3mm 6mm")
      : "14mm";
