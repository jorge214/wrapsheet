...
export type PdfExtra = {
  ...
  nativePrint?: boolean;
  // iPad: o WKWebView do expo-print usa "desktop-class browsing" e posiciona a
  // tabela larga de forma diferente (desvio p/ a direita). SÓ no iPad tranca-se
  // a tabela dos dias em table-layout:fixed com larguras de coluna, para não
  // poder desviar. iPhone/PC ficam intocados (não recebem esta flag).
  ipadPdf?: boolean;
};
        ...
        * {
        ...
        @media print {
          ...
          ${extra?.orientation === "portrait"
            ? "body { font-size: 9px; } .titleBox { font-size: 13px; } .k, .v, .uv { font-size: 10px; } .days th { font-size: 8px; } .days td { font-size: 10px; } .days th, .days td { padding: 4px 1.45px; } .secTitle { font-size: 10px; } table.rates { table-layout: auto; } .condMain { font-size: 10px; padding: 3px 8px; } .condT { font-size: 8.5px; padding: 3px 4px; } .condB, .conditionsBody { font-size: 9.5px; line-height: 1.28; padding: 3px 6px; } .condRow { grid-template-columns: 150px minmax(0, 1fr); } .days td.cData { min-width: 60px; } .days td.cSal { min-width: 54px; }" + (extra?.ipadPdf ? " table.days { table-layout: fixed; } .days td, .days th { overflow: hidden; } .days col.col-desc { width: 9%; } .days col.col-data { width: 7.5%; } .days col.col-sal { width: 5.5%; } .days col.col-cont { width: 2.5%; } .days col.col-ini { width: 4%; } .days col.col-ref { width: 5%; } .days col.col-fim { width: 4%; } .days col.col-ht { width: 5.5%; } .days col.col-hd { width: 5.5%; } .days col.col-pd { width: 4.2%; } .days col.col-ott { width: 3%; } .days col.col-otv { width: 4.6%; } .days col.col-tot { width: 6.4%; }" : "")
